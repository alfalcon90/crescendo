  ...
  return (
    <PageContainer className="overflow-x-clip" >
      ...
      <SectionContainer className="relative max-w-4xl">
        ...
        <Paragraph>
          I successfully completed my Master&apos;s degree in Performance Psychology in 2024, with GPA of 4.0 and honors distinction. After this, I obtained official designation as a Certified Mental Performance Consultant (CMPC), a qualification offered by the Association for Applied Sport Psychology. AASP describes the certification as follows: &quot;Certified Mental Performance Consultants recognized by the Association of Applied Sport Psychology are the most capable sport and performance psychology providers. They have met the highest standard in education, training, and supervised practice, and they have passed a required certification exam to demonstrate their competence as a practitioner. CMPCs also are governed by and committed to high standards of ethical conduct when providing services to the public.&quot; You can find out more about CMPCs <Link className="underline" href="https://appliedsportpsych.org/site/assets/files/1016/cmpc-onepage.pdf" >here</Link>.
          <br />
          <br />
