    ...
    <PageContainer className="overflow-x-clip" >
      ...
      <SectionContainer className="relative max-w-4xl">
        ...
        <Paragraph>
          ...
          <br />
          <br />
          In addition to providing consultation services to individual and group clients, I have the privilege of teaching &quot;Performance Psychology&apos; at two institutions, the University of Northern Colorado and the University of Denver&apos;s Lamont School of Music.
          <br />
          <br />
          Over the years, I&apos;ve had the opportunity to conduct a range of workshops centered around the theme of performance psychology for a variety of organizations. To name a few examples, I&apos;ve led sessions at the International Festival-Institute at Round Top, collaborated with Dr. Noa Kageyama for a group meeting for Bulletproof Musician, presented at the International Clarinet Association, and worked with several other universities and music schools across the United States.
          <br />
          <br />
